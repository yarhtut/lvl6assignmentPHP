...
<div class="update product vegetables">
    ...
    <button class="ajax update">Update Bakery</button>
    <button class="ajax delete">Delete Bakery</button>
...
<script>
    ...
    $(".ajax.update").click(function(){
        ...
        $.ajax({
            url : "update.php?action=update_product_bakerys",
            method : "GET",
            success : function(response){
    ...
    $(".ajax.delete").click(function(){
        ...
        $.ajax({
            url : "update.php?action=delete_product_bakerys",
            method : "GET",
            success : function(response){
